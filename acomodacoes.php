        	...
        	<div class="container">
                ...
                <div class="col-lg-2"></div>
                	 <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        ...
                        <div class="texto">
                        	<p>Estamos em constates modernizações e investimentos em infraestrutura para acomodar melhor nossos clientes e
                            perimar pelo aconchego e conforto para seu descanso</p>
                        </div>
                        <div class="owl-slide">
		          		<div class="item">
        		        	<img src="images/img-acomod-1.png" alt="Owl Image"/>
                		</div>
						<div class="item">
        		        	<img src="images/img-acomod-2.png" alt="Owl Image"/>
                		</div>
	                </div>
                     </div>
                     <div class="col-lg-2"></div>
