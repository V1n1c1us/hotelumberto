...
<html lang="pt-br">
    <head>
        ...
        <title>Hotel umberto - Evento</title>
                ...
                <div class="navigator">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="active"><a href="evento.php">Eventos</a></li>
                ...
                <div class="col-lg-2"></div>
                	 <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        ...
                        <div class="desc-eventos">
	                        <ul>
    	                    	<li class="data-evento">17.06.2016</li>
                              	<li>
                                	<p> Estamos em constates modernizações e investimentos em infraestrutura para acomodar melhor nossos clientes.
                                    e primar pelo aconchego e conforto para seu descanso.
                                    </p>
                                </li>
                                <li>17.06.2016</li>
                              	<li>
