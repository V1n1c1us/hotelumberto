...
<nav class="navbar animate top">
          <div class="container">
    <div class="area-logo"> <a href="http://hotelumberto.com.br/"><img src="images/logoHotel.png" alt="Hotel Umberto"> </a> </div>
...
<section class="middle">
    ...
    <div class="row">
     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="hidden-xs hidden-sm" id="cont_e3e8a7bad2fec8cec6373543d77a7ec8" class="prev-tempo"><span id="h_e3e8a7bad2fec8cec6373543d77a7ec8"><a class="LinkWid" href="http://www.tempo.pt/santa-maria-aero-porto_brasil-l12994.htm" target="_blank" style="font-family:Helvetica; font-size:13px; color:#ff6600;">Hotel Umberto Informa</a></span><script type="text/javascript" async src="http://www.tempo.pt/wid_loader/e3e8a7bad2fec8cec6373543d77a7ec8"></script></div>
        
        <div class="hidden-lg hidden-md" id="cont_d6a9fcc506ea2c21c6aef41b14457e05"><script type="text/javascript" async src="https://www.tempo.pt/wid_loader/d6a9fcc506ea2c21c6aef41b14457e05"></script></div>
      </div>
     </div> 
    <div class="row">
    ...
    <div class="row">
    	<div class="col-lg-12">
        	<div class="depoimentos-geral">
                  ...
                  <div class="row">
             	  <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2"></div>
              	  <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                  	<h5 class="cabecalho">Visitou nosso espaço? Envia <span class="depoimento-destaque">AQUI</span> seu depoimento</h5>
				...
				<div class="cardapio-setas"> <a id="left" onclick="menuList('pasteis-p3')"><i class="fa fa-arrow-left"></i></a> <a id="right" onclick="menuList('pasteis-p2')"><i class="fa fa-arrow-right"></i></a> </div>
...
<div class="clearfix"></div>
<section class="middle-visitar">
          <div class="container">
    <div class="row visitar">
              <div class="col-lg-12 col-md-12">
        <h2>VENHAM NOS VISITAR!</h2>
      </div>
              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
        <ul class="visitar">
        ...
        <div class="social"> <a href="https://www.facebook.com/hotelumbertosantamaria/?fref=ts"><img src="images/img-facebook.png"/></i></a> </div>
      </div>
            </div>
  </div>
        </section>
