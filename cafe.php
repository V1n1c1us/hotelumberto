    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="texto">
                    <p>Nosso hotel oferece um excelente café da manhã, em que você pode desfrutar de nossas delicias com
                        todo sabor e conforto para que você sinta-se em casa.</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="owl-carousel-cafe">
                    <div class="owl-item">
                    ...
                    <div class="owl-item">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <a href="images/cafe/thumb/img-cafe-10.JPG" data-lightbox="image-10">
                                <img class="img-responsive" src="images/cafe/thumb/img-cafe-10.JPG"
                                     alt="Café da Manhã"/>
                            </a>
                        </div>
                    </div>
...
<script>
    $(document).ready(function () {
        if ($(".owl-carousel-cafe").length > 0) {
            $(".owl-carousel-cafe").owlCarousel({
                autoplay: false,
                dots: true,
                nav: true,
                loop: true,
