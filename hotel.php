        	...
        	<div class="container">
                ...
                <div class="col-lg-2"></div>
                	 <div class="col-lg-8 col-md-8 col-sm-4 col-xs-12">
                        ...
                        <div class="texto">
                        	<p>O Hotel Umberto é uma empresa local de gestão familiar que atua no serviço de hotelaria a mais de 60 anos.
                            Possuindo em sua estrutura apartamentos com banheiro privativo, ar condicionado, frigobar, internet wi-fi, tv a cabo
                            , café da manhã e serviços secundários de estacionamento com manobrista, lavanderia e serviços de quarto, isso tudo
                            aliado à praticidade de uma localização privilegiada.</p>
                        </div>
                     </div>
                      <div class="col-lg-2"></div>
                </div>
                <div class="col-lg-2"></div>
                	 <div class="col-lg-8 col-md-8 col-sm-4 col-xs-12">
                     	<div class="sub-texto">
                        	<p>Buscamos oferecer aos nossos clientes uma hospedagem aconchegante em acomodações confortáveis, disponibilizando
                            um atendimento diferenciado e personalizado</p>
                        </div>
                     </div>
                      <div class="col-lg-2"></div>
                </div>
